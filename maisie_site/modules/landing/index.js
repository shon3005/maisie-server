  ...
  <div>
    <div className="landing container">
        ...
        <div className="landing-reasons">
          ...
          {[["https://s3.amazonaws.com/maisie-files/shared/affordable.svg", "Affordable", "Maisie is many times more affordable than one-on-one options, and does not require insurance to get started."],
