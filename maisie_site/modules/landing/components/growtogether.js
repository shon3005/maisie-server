export default () =>
  <div className="landing-grow row-fe-c" style={{backgroundImage: "url('https://s3.amazonaws.com/maisie-files/shared/campfire_o.png')", backgroundSize: "cover", backgroundPosition: "center"}}>
    <div className="landing-grow_cont col-c">
      <img src="https://s3.amazonaws.com/maisie-files/shared/campfire.svg" />
