        ...
        <div className={classNames(["circle_right__inner", "col-fs-c", { "dark_theme": this.props.dark }])}>
          <div className="circle_right__inner_cont col-fs-c">
            ...
            {!isHostCircle ? <div className="circle_right__inner_cont-join">
              <Button saving={this.state.joining} kind="primary" weight="purple" onClick={(a) => this.handleJoin(this.props.status, this.props.client, this.props.circle.id, this.props.circle.user.host.id)} className={classNames({
