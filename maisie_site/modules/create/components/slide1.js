    ...
    <div className="create__inner_cont">
      ...
      <Field title="Host">
        <div className="create__hostinfo row-fs-c">
          <div className="create__hostinfo-img" style={{backgroundImage: `url(${props.user.host.imageUrl || 'https://s3.amazonaws.com/maisie-files/shared/profile-default.svg'})`, backgroundSize: "cover", backgroundPosition: "center"}} />
