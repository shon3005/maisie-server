defmodule MaisieApi.Services.Circle do
  ...
  def changeset(circle, attrs) do
    circle
    |> cast(attrs, [:title, :description, :price, :frequency, :length, :location_type, :neighborhood, :address, :hour, :minute, :ampm, :min, :max, :tags, :start_date, :who_should_join, :user_id])
    |> validate_required([
      :title,
      :description,
      :price,
